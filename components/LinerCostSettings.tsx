    ...
    <div className="bg-slate-800 rounded-lg p-6">
      <div className="flex items-center justify-between border-b border-slate-700 pb-4">
        <div className="flex items-center gap-3">
          <label htmlFor="cost-toggle" className="text-xl font-semibold text-white cursor-pointer">Liner Cost Calculation</label>
        ...
        <input
            ...
            className="form-checkbox h-5 w-5 rounded border-slate-500 bg-slate-700 text-cyan-500 focus:ring-2 focus:ring-offset-0 focus:ring-offset-slate-800 focus:ring-cyan-500 transition cursor-pointer flex-shrink-0"
            id="cost-toggle"
        />
      </div>
      <div className={`transition-all duration-300 ease-in-out ${calculateLinerCost ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
        <div className="flex items-center justify-between pt-4">
          <label className="font-medium text-slate-200 text-base">
